...
if __name__ == "__main__":
    ...
    extensions_to_look_for = {".js", ".ts", ".mjs", ".json", ".css", ".html", ".md", ".py", ".jsx", ".tsx", ".txt", ".yaml", ".yml", ".sh", ".bash", ".zsh", ".fish", ".bat"}
    exclude_files_list = {".env", ".env.local", ".env.development", ".env.production", ".env.test", ".env.development.local", ".env.production.local", ".env.test.local", "__init__.py", "init.py", "CHANGELOG.md", "code_base.md"}
    exclude_folders_list = {"venv", "docs", ""}
